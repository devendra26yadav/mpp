...
-- =====================================================
-- SAMPLE DATA FOR: DepartmentProject
-- =====================================================
INSERT INTO DepartmentProject (departmentId, projectId) VALUES
(1, 1),  -- Engineering -> Project Apollo
(1, 2),  -- Engineering -> Project Orion
(3, 3),  -- Finance -> Project Titan
(4, 4),  -- Marketing -> Project Zenith
(5, 5);  -- IT Support -> Project Helios

-- =====================================================
-- SAMPLE DATA FOR: EmployeeProject
-- =====================================================
...
-- =====================================================
-- SAMPLE DATA FOR: ProjectClient
-- =====================================================
INSERT INTO ProjectClient (projectId, clientId) VALUES
(1, 1),  -- Apollo → TechNova
(1, 4),  -- Apollo → InnoHealth
(2, 3),  -- Orion → BrightWorks
(3, 2),  -- Titan → FinEdge
(4, 3);  -- Zenith → BrightWorks


-- added later on the above initial data

-- Ends in 2 weeks → falls in 30 days window
INSERT INTO Project (id, name, description, startDate, endDate, budget, status)
VALUES (101, 'Quick Project', 'Ends in 2 weeks', '2025-10-15', '2025-11-05', 5000, 'Active');

-- Ends in 45 days → falls in 60 days window
INSERT INTO Project (id, name, description, startDate, endDate, budget, status)
VALUES (102, 'Medium Project', 'Ends in 45 days', '2025-10-01', '2025-12-06', 10000, 'Active');

-- Ends in 65 days → falls in 70 days window
INSERT INTO Project (id, name, description, startDate, endDate, budget, status)
VALUES (103, 'Long Project', 'Ends in 65 days', '2025-10-01', '2025-12-26', 20000, 'Active');
INSERT INTO Client (id, name, industry, contactPersonName, contactPhone, contactEmail)
VALUES (201, 'Acme Corp', 'Manufacturing', 'John Doe', '123-456-7890', 'john@acme.com');

INSERT INTO Client (id, name, industry, contactPersonName, contactPhone, contactEmail)
VALUES (202, 'Beta LLC', 'IT Services', 'Jane Smith', '234-567-8901', 'jane@beta.com');

INSERT INTO Client (id, name, industry, contactPersonName, contactPhone, contactEmail)
VALUES (203, 'Gamma Inc', 'Healthcare', 'Mike Johnson', '345-678-9012', 'mike@gamma.com');

-- 30-day project
INSERT INTO ProjectClient (projectId, clientId) VALUES (101, 201);

-- 60-day project
INSERT INTO ProjectClient (projectId, clientId) VALUES (102, 202);

-- 70-day project
INSERT INTO ProjectClient (projectId, clientId) VALUES (103, 203);
