...
public class EmployeeInfo {
	...
	public static void main(String[] args) {
		...
		System.out.println("Comparator Fixed as consistency with equals");
		Employee e3 = new Employee("Max",32000);
		Employee e4 = new Employee("Max",32000);
		EmployeeComparator ec = new EmployeeComparator();
		System.out.println(ec.compare(e3,e4));
